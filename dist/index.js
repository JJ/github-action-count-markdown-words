...
const { unified } = __nccwpck_require__(3996);
const remarkParse = (__nccwpck_require__(1602)/* ["default"] */ .A);
...
class VFile {
  ...
  get basename() {
    return typeof this.path === 'string'
      ? external_node_path_.basename(this.path)
      : undefined
  }
  ...
  get dirname() {
    return typeof this.path === 'string'
      ? external_node_path_.dirname(this.path)
      : undefined
  }
  ...
  get extname() {
    return typeof this.path === 'string'
      ? external_node_path_.extname(this.path)
      : undefined
  }
...
const path = __nccwpck_require__(6760);
const { countRepositoryWords } = __nccwpck_require__(9559);
let corePromise;

async function getCore() {
  if (!corePromise) {
    corePromise = __nccwpck_require__.e(/* import() */ 421).then(__nccwpck_require__.bind(__nccwpck_require__, 6421));
  }
